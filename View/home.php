...
<script>
	...
	socket.on("show message", function(data) {
		...
		if (data.id == localStorage.id) {
			...
			data.data.forEach(function(doc) {
				...
				var element = "<div class=\"item\" tabindex=\"0\"><img src=\"" + image + "\" alt=\"user image\" class=\"online\"><p class=\"message\"><a href=\"#\" class=\"name\"><small class=\"text-muted pull-right\"><i class=\"fa fa-clock-o\"></i> " + doc.time + "</small>" + doc.name + "</a> " + doc.msg + "</p></div>";
	...
	socket.on('receive message', function(data) {
		...
		var element = "<div class=\"item\" tabindex=\"0\"><img src=\"" + image + "\" alt=\"user image\" class=\"online\"><p class=\"message\"><a href=\"#\" class=\"name\"><small class=\"text-muted pull-right\"><i class=\"fa fa-clock-o\"></i> " + data.time + "</small>" + data.name + "</a> " + data.msg + "</p></div>";
		$("#chat-box").append(element);
